...
function Goal({ goal }) {
    ...
    return (
        <div className='p-3 rounded-3xl shadow-md shadow-gray-900 from-blue-950 via-violet-950 from-10% via-50% to-90% to-transparent bg-gradient-to-r flex flex-col gap-y-6'>
            ...
            <div className="flex justify-between item-start">
                ...
                <button disabled={percent == 100 ? false : true} className='px-2 py-1 text-xs text-black rounded-3xl bg-yellow-400 disabled:opacity-40'>
