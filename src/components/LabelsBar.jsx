    ...
    return (
        <div className='w-full flex flex-nowrap gap-x-3 pt-1 px-3'>
            <div
                ...
                className={`px-3 py-1 h-fit rounded-3xl shadow-md shadow-black bg-gray-700 flex justify-center items-center text-white`}>
                <div className='w-5'>
                    <PlusIcon />
                </div>
            </div>

            <div className='overflow-x-scroll flex flex-nowrap gap-x-3 pb-3'>
                ...
                {labels.map(label => (
                    <div
                        ...
                        className={`px-3 py-1 rounded-3xl ${label._id === selectedLabel ? 'bg-emerald-600' : 'bg-gray-700'} shadow-md shadow-black text-sm text-white`}>{label.name}</div>
                ))}
            </div>
